...
from agents.pokedex_expert import pokedex_expert, PokedexDependencies
from agents.trade_market_analyst import trade_market_analyst, MarketDependencies
...
class TestMultiAgentOrchestration:
    ...
    @pytest.mark.anyio
    async def test_delegation_to_pokedex(self, mock_deps, monkeypatch):
    ...
    @pytest.mark.anyio
    async def test_delegation_to_market(self, mock_deps, monkeypatch):
